  ...
  return (
    <div className=" py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold dark:text-teal-500 text-teal-700 text-center mb-12 font-raleway">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          {/* Info Panel */}
          <div className="space-y-6 dark:text-white text-gray-700 text-lg">
